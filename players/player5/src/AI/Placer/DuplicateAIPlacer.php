...
class DuplicateAIPlacer implements AIPlacerInterface
{
    public function place(): array
    {
        return [
            (new Ship\Battleship())->setOrigin(new Coordinates(1, 1), Ship\ShipInterface::VERTICAL),
            (new Ship\Battleship())->setOrigin(new Coordinates(10, 1), Ship\ShipInterface::VERTICAL),
